...
Oppdatert: 2026-06-10 (WBS 8.1 – nytt korrelasjonsvarmekart (Figur 8.3) lagt til i kap. 8 og koblet til §9.3 som empirisk belegg for støygulvet; analyseskript og artefakter i aktivitet 07, og `rapport_final.pdf` regenerert. Samme dag tidligere: §9.3 utvidet til en eksplisitt «Hvorfor presterer modellene så likt?»-del med parsimoni-poeng. Tidligere 2026-06-08: veiledertilbakemelding innarbeidet i ny revisjon.)
