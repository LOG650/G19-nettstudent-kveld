...
Oppdatert: 2026-04-16 (WBS 7.1.7)
...
- [ ] H: Rapportskriving er langt på vei fullført: WBS 7.1.1–7.1.7 er dokumentert med Sammendrag, Abstract, ferdigstilt innledning (inkl. ny §1.2 Delproblemer), problemstilling, avgrensinger, antagelser, litteratur, teori, casebeskrivelse, metode og data, modellering, analyse, resultat, diskusjon (9.1–9.5), konklusjon og bibliografi. Rapportfasen er brutt ned i WBS 7.1.1–7.3.3, og gjenstående aktiviteter er 7.2.x (figurer og tabeller) og 7.3.x (kvalitetssikring). `delvis verifisert`
...
- [x] Starte løpende rapportskriving parallelt med analysearbeidet, i tråd med arbeidsreglene i prosjektet. `påbegynt 2026-03-30, utvidet 2026-04-02 med modellnotater for WBS 4.1, 4.2, 4.3, 4.4 og 5.1, utvidet 2026-04-07 med korte notater for WBS 5.2, 5.3, 5.4, 6.1 og 6.2, utvidet 2026-04-12 med praktisk nytte i WBS 6.3 og en kort konklusjonssetning, utvidet 2026-04-16 med reorganisert diskusjon (9.1–9.5), utvidet konklusjon, Sammendrag og Abstract for WBS 7.1.6, og ferdigstilt 2026-04-16 med kalibrert innledning og ny §1.2 Delproblemer for WBS 7.1.7`
