...
Oppdatert: 2026-04-19 (WBS 7.2.1)
...
- [ ] H: Rapportskriving er langt på vei fullført: WBS 7.1.1–7.1.7 er dokumentert med Sammendrag, Abstract, ferdigstilt innledning (inkl. ny §1.2 Delproblemer), problemstilling, avgrensinger, antagelser, litteratur, teori, casebeskrivelse, metode og data, modellering, analyse, resultat, diskusjon (9.1–9.5), konklusjon og bibliografi. Figur-/tabellutvalget for hele rapporten er låst i WBS 7.2.1. Rapportfasen er brutt ned i WBS 7.1.1–7.3.3, og gjenstående aktiviteter er 7.2.2–7.2.4 (produksjon og innsetting av figurer og tabeller) og 7.3.x (kvalitetssikring). `delvis verifisert`
...
- [x] WBS 7.2.1: Velge hvilke figurer og tabeller som faktisk skal inn i rapporten. Utvalget er dokumentert i [rapport_fig_tab_utvalg.md](rapport_fig_tab_utvalg.md) med 12 figurer, 14 innholdstabeller og 7 vedleggsreferanser, og knytter hver artefakt til kilde i `006 analysis/`. `fullført 2026-04-19`
...
Prosjektet fremstår per 2026-04-19 som værende ferdig med all analyse (WBS 2.x–6.x), hele rapportskrivingen i WBS 7.1 og nå også figur-/tabellutvalget i WBS 7.2.1. WBS 7.1.1–7.1.7 er fullført: rapport.md har fått Sammendrag (277 ord) og Abstract (298 ord), ferdigstilt innledning med problemstilling, ny §1.2 Delproblemer, avgrensinger og antagelser, litteraturkapittel, teorikapittel (3.1–3.4), casebeskrivelse (4.1–4.4), kapittel 5 Metode og data (5.1 Metode og 5.2 Data med Tabell 5.1), kapittel 6 Modellering, kapittel 7 Analyse og kapittel 8 Resultat med fire kjernetabeller (8.1–8.4), kapittel 9 Diskusjon med fem underkapitler (9.1 Tolkning av hovedfunn, 9.2 Variablenes påvirkning, 9.3 Praktisk nytte for Dagligvare, 9.4 Metodiske begrensninger, 9.5 Videre arbeid), kapittel 10 Konklusjon og kapittel 11 Bibliografi. I WBS 7.2.1 er figur- og tabellutvalget låst til 12 figurer (5 beholdes, 2 kopieres inn og 5 produseres som nye plott) og 14 innholdstabeller (5 beholdes, 10 er nye), og i tillegg 7 vedleggsreferanser til stort datamateriale. Utvalget er dokumentert i [rapport_fig_tab_utvalg.md](rapport_fig_tab_utvalg.md), og ingen artefakter oppgir ekstern kildehenvisning siden alle er egenproduserte. Neste steg er 7.2.2 (figurer og tabeller til case-/datakapitlet), 7.2.3 (analyse-, resultat- og diskusjonsfigurer/-tabeller), 7.2.4 (innsetting, nummerering og formatering) og deretter 7.3.x (kvalitetssikring).
