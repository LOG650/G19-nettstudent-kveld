...
Oppdatert: 2026-04-21 (WBS 7.3.1 fullført – alle fire svakheter V1–V4 fra reviewen er rettet)
...
Prosjektet fremstår per 2026-04-21 som værende ferdig med all analyse (WBS 2.x–6.x), hele rapportskrivingen i WBS 7.1, hele figur-/tabellblokken WBS 7.2 og hele WBS 7.3.1 struktur- og kravsjekk. [rapport.md](../005%20report/rapport.md) inneholder nå 10 nummererte innholdsfigurer (Figur 4.1–4.3, 5.1–5.2, 7.1–7.2, 8.1–8.3) og 16 innholdstabeller (Tabell 5.1–5.4, 6.1–6.2, 7.1–7.2, 8.1–8.4, 9.1–9.3, 12.1) og vedleggsreferanser A1–A7. Forsiden er fylt ut med tittel, forfattere, studiepoeng (15), veileder (BIP), egenerklæringer (alle seks avkrysset), personvern (ikke omfattet), publisering (Ja) og båndlegging (Nei); innleveringsdato, sidetall og dato står som TODO-markører til like før innlevering. Innholdsfortegnelsen dekker nå §§ 3.1–3.4, og §§ 1.1–1.4 er endret fra H2 til H3 slik at overskriftsnivået er konsistent med resten av rapporten. Tabellnummereringen i kap. 5 starter på Tabell 5.1 og matcher tekstrekkefølgen (formkrav 1). Gjenstående steg er WBS 7.3.2 konsistenssjekk mot analyseartefakter og WBS 7.3.3 språkvask og låsing av førsteutkastet (inkluderer F1/F2 fra 7.3.1-reviewen). F3 (ikke-fagfellevurderte kilder) og eksplisitt dokumentasjon av M5-forsinkelsen er overført til WBS 8.1.
