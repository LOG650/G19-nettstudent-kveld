...
- [ ] Statusgrunnlaget for modellutvikling, prognoseleveranse, evalueringsmetrikker, modellsammenligning, analyse av viktige variabler, tolkning av modellresultatene og første diskusjon av styrker og svakheter er nå dokumentert gjennom feature engineering, datasplitt, eksplorativ analyse, lineær regresjon i WBS 4.1, Random Forest i WBS 4.2, et lett felles verifiseringssteg i WBS 4.3, parameterjustering av Random Forest i WBS 4.4, genererte 2025-prognoser i WBS 5.1, beregnede 2025-`RMSE`/`MAPE` i WBS 5.2, sammenligning av modellresultatene i WBS 5.3, variabelanalyse i WBS 5.4, tolkning i WBS 6.1 og diskusjon i WBS 6.2, men praktisk nytte og større deler av rapportarbeidet mangler fortsatt. `delvis verifisert`
...
- [x] G: Prognoser for 2025, `RMSE`/`MAPE`, modellsammenligning, analyse av viktige variabler, tolkning av modellmønstre og første diskusjon av styrker og svakheter er nå dokumentert i WBS 5.1, 5.2, 5.3, 5.4, 6.1 og 6.2 for lineær regresjon, Random Forest-baseline og tuned Random Forest. `tuned RF` fremstår samlet som anbefalt modell på 2025-data, vinner `RMSE` i de fleste måneder og segmenter, men `MAPE` varierer tydeligere mellom kvartal, rabatt, region og salgsnivå. `verifisert`
- [ ] H: Rapportskriving er påbegynt med korte metode-, modellerings-, analyse- og diskusjonsnotater om WBS 4.1, 4.2, 4.3, 4.4, 5.1, 5.2, 5.3, 5.4, 6.1 og 6.2, men hoveddelen av rapportarbeidet er fortsatt ikke dokumentert i rapportmappen. `delvis verifisert`
...
- [x] Starte løpende rapportskriving parallelt med analysearbeidet, i tråd med arbeidsreglene i prosjektet. `påbegynt 2026-03-30, utvidet 2026-04-02 med modellnotater for WBS 4.1, 4.2, 4.3, 4.4 og 5.1, og utvidet 2026-04-07 med korte notater for WBS 5.2, 5.3, 5.4, 6.1 og 6.2`
- [ ] Oppdatere denne statuslisten etter ukentlige statusmøter og ved milepæler.

## Anbefalt kort prosjektstatus

Prosjektet fremstår per 2026-04-07 som værende ferdig med planfasen, med dataforståelse, datasettdokumentasjon, remappet datarensing, feature engineering, datasplitt, eksplorativ analyse, lineær regresjon for WBS 4.1, Random Forest for WBS 4.2, felles verifisering av treningsgrunnlaget i WBS 4.3, parameterjustering av Random Forest i WBS 4.4, genererte 2025-prognoser i WBS 5.1, beregnede 2025-`RMSE`/`MAPE` i WBS 5.2, dokumentert modellsammenligning i WBS 5.3, analysert variabelprioritering i WBS 5.4, tolket modellmønstre i WBS 6.1 og diskutert styrker og svakheter i WBS 6.2. `tuned RF` fremstår samlet som beste modell på 2025-data, og WBS 6.2 viser at modellvalget er robust på absoluttfeil innenfor dette oppsettet, mens generaliserbarheten begrenses av ett datasett, én simulert virksomhet og fravær av eksterne makrovariabler. Neste kritiske behov er å vurdere praktisk nytte og bygge disse funnene tydelig inn i rapporten.
