...
|-------|-------------|----------------|
| `source_index` | Source chapter index (e.g., `2.1`) | Yes |
| `target_index` | Target part.position (e.g., `3.2`) | Yes |

## Workflow

1. **Locate source chapter** - Find chapter by source_index
2. **Determine target number** - Position specified in target_index or append to end
