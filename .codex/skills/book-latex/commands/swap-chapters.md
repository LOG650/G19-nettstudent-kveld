...
Exchanges the positions of two chapters within the same part.

## Required Information

| Field | Description | Ask if missing |
|-------|-------------|----------------|
| `index1` | First chapter index (e.g., `2.2`) | Yes |
| `index2` | Second chapter index (e.g., `2.5`) | Yes |

Note: Both chapters must be in the same part (first digit of index must match).

## Workflow

1. **Locate both chapters** - Find by index
