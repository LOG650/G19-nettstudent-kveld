...
|-------|-------------|----------------|
| `source_index` | Source section index (e.g., `2.1.3`) | Yes |
| `target_chapter_index` | Target chapter index (e.g., `2.2`) | Yes |

## Workflow

1. **Locate source section** - Find section by source_index
